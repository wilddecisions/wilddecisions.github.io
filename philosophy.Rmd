...
#### [**Inclusivity in Wildlife Biology**]{.ul}

I believe that **diversity and inclusion** are critical to the professional field of wildlife biology because a more inclusive workforce will improve our work, better engage the public, and ultimately enact positive societal change into the future. To this end, I aim to promote positive change in wildlife biology through three mechanisms: **environment**, **recruitment**, and **retention**. I will create an **inclusive laboratory environment** by embracing DEI as core values that are embedded within lab activities. Examples include, but are not limited to, having **explicit lab policies** that promote inclusivity (e.g., harassment and accommodation policies), participating in scientific societies and conferences that serve underrepresented groups (e.g., Society for the Advancement of Chicanos and Native Americans in Science), and seeking out **research collaborations** with institutions that support inclusivity (e.g., tribal colleges, HBCUs, NSF Research Experience for Undergraduate [REU] Programs). These activities and societies will then provide opportunities for **recruitment** of promising students from historically underrepresented groups in wildlife biology to join our lab. Diversity will be **celebrated** within the lab and will ultimately benefit our work through different backgrounds, life experiences, and viewpoints. For example, I am proud of the diverse students I have mentored in undergraduate and graduate studies to date, four of which went on to pursue and receive graduate degrees in wildlife sciences.
