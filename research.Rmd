...
<div style="float:right; width:30%; margin-left:15px; text-align:center; font-family:Arial, sans-serif; font-size:0.8em;">
  <img src="images/lion_horse.jpg" style="width:100%; border:2px solid;">
  <div style="margin-top:4px;">Photo: D Stoner.</div>
</div>
