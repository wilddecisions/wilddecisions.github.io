...
We have been involved in a project to **integrate analysis** of long-term datasets and estimate historical and future population dynamics of the **Mojave Desert Tortoise** across the species range. We used a **co-production approach** to elicit important threats and management actions, and then using advanced machine-learning and geospatial techniques to estimate landscape-scale threat layers. Ultimately, we aim to model population dynamics as a consequence of past and future threats and management, with the goal of helping wildlife managers more effectively manage tortoise populations across the species range. Three manuscripts summarizing this work are 'under review'.
